  ...
  if (!authed) {
    return (
      <main dir="rtl" style={wrap}><div style={card}>
        <div style={hdr}><img src="/logo-mark.png" alt="events360" style={logo} /><h1 style={{ fontSize: 20, fontWeight: 800, margin: 0 }}>קונסולת מפעיל — events360</h1></div>
    ...
    <main dir="rtl" style={wrap}>
      ...
      <div style={{ ...card, maxWidth: 920 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14, flexWrap: 'wrap', gap: 8 }}>
          <div style={hdr}><img src="/logo-mark.png" alt="events360" style={logo} /><h1 style={{ fontSize: 20, fontWeight: 800, margin: 0 }}>ניהול חשבונות ורישיונות</h1></div>
...
const logo: React.CSSProperties = { width: 44, height: 44, borderRadius: 11, objectFit: 'cover' };
